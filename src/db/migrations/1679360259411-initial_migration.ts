...
export class initialMigration1679360259411 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subscriptions" ("id" SERIAL NOT NULL, "startDate" TIMESTAMP NOT NULL, "interval" character varying NOT NULL, "amount" integer NOT NULL, "nextPaymentDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "paymentMethodId" integer, CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "donations" ("id" SERIAL NOT NULL, "amount" integer NOT NULL, "paymentDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "subscriptionId" integer, "paymentMethodId" integer, CONSTRAINT "PK_c01355d6f6f50fc6d1b4a946abf" PRIMARY KEY ("id"))`);
